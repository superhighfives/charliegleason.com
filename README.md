...
> **Note:** This is a public mirror of `apps/web/` from a private monorepo. It's automatically synced on every push to main. The full monorepo also includes [charliegleason-visitor-counter](https://github.com/superhighfives/charliegleason-visitor-counter) and [charliegleason-lastfm-tracker](https://github.com/superhighfives/charliegleason-lastfm-tracker) Durable Objects that power some of the site's real-time features, plus a [private content template](https://github.com/superhighfives/charliegleason-private-content) showing how password-protected routes work.
