...
description: Machine learning, art, accelerometers, and the joy of slow progress and fast feedback loops (or, how I built  [Lysterfield Lake](https://lysterfieldlake.com/))
...
[Lysterfield Lake](https://wearebrightly.com/)  is a song about a place outside Melbourne, Australia. It's about the  endless summers of your youth, and the tiny changes in you that you don't even notice adding up. It's also about memories, which, like polaroids, fade and change over time.
