  ...
  <dl className="grid justify-start grid-cols-6 gap-y-4">
    {metadata.map(
      (data: { name: string; content: string | [] }) => {
        const classes = "text-sm space-y-2 col-span-full sm:col-span-4 lg:col-span-4 sm:border-t dark:border-neutral-700 sm:pt-4"
        return (
          <Fragment key={data.name}>
            <dt className="font-mono text-xs col-span-full sm:col-span-2 lg:col-span-2 border-t dark:border-neutral-700 pt-4">{data.name}</dt>
