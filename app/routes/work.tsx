    ...
    <>
      ...
      <Layout variant="full">
        <main className="sm:border border-neutral-200 dark:border-neutral-700 pb-8 max-sm:pt-16 xl:pb-20 rounded">
          <div className="grid grid-cols-prose-sm sm:grid-cols-prose pt-0 xl:pt-16 pb-2 xl:pb-16 xl:gap-x-8 gap-y-8 rounded-md bg-white dark:bg-neutral-900 relative">
