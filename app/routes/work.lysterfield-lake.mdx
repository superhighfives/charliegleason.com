...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-dreams-grid.png" alt="A frame of each of the initial dreams." mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-process-diagram.png" alt="A diagram showing the process of how the technology works under the hood." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-avatar-diagram.png" alt="A diagram of how the avatar is generated." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-avatar-preview.png" alt="A preview of the generated avatar, from frame to 3D avatar." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-background-diagram.png" alt="A diagram showing how the background is generated." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-background-preview.png" alt="A preview of the background, from frame to watercolour background." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-outline-diagram.png" alt="A diagram showing how the outline is generated." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-outline-preview.png" alt="A preview of the diagram, from frame to outline." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-dreams-diagram.png" alt="A diagram showing the dreams." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-dreams-preview.png" alt="A preview showing the dreams, from the original frames." themed mobile />
</div>
...
<div className="wide">
  <Picture src="/assets/case-studies/lysterfield-lake/image-interpolation-diagram.png" alt="A diagram showing the interpolation process." themed mobile />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-lyrics.png" alt="The lyrics that are get overlaid on the polaroids." mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-frames-overlaid.png" alt="An example of each frame, with the different dream for each." themed mobile />
</div>
...
<div className="wide">
  <Picture src="/assets/case-studies/lysterfield-lake/image-stack-diagram.png" alt="An example of how the elements of the avatar are stitched together." themed mobile />
</div>
