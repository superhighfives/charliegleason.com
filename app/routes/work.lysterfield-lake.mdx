...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-polaroids-full.jpg" alt="A selection of dreams from the final video." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-polaroid-three.jpg" alt="Three polaroids containing the singer and lyrics overlaid." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-dreams-grid.jpg" alt="A frame of each of the initial dreams." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-process-diagram.png" alt="A diagram showing the process of how the technology works under the hood." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-process-diagram.png" alt="A preview of the finished process." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-avatar-diagram.png" alt="A diagram of how the avatar is generated." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-avatar-preview.png" alt="A preview of the generated avatar, from frame to 3D avatar." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-background-diagram.png" alt="A diagram showing how the background is generated." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-background-preview.png" alt="A preview of the background, from frame to watercolour background." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-outline-diagram.png" alt="A diagram showing how the outline is generated." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-outline-preview.png" alt="A preview of the diagram, from frame to outline." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-dreams-diagram.png" alt="A diagram showing the dreams." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-dreams-diagram.png" alt="A preview showing the dreams, from the original frames." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-interpolation-diagram.png" alt="A diagram showing the interpolation process." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-frames-overlaid.png" alt="An example of each frame, with the different dream for each." />
</div>
...
<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-stack-diagram.png" alt="An example of how the elements of the avatar are stitched together." />
</div>
