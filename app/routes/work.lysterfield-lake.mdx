...
<Metadata gradient={attributes.handle.gradient} metadata={attributes.handle.metadata} />

<div className="full">
  <Picture src="/assets/case-studies/lysterfield-lake/image-polaroids-full.webp" alt="A selection of dreams from the final video." zoom />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-avatar-diagram.webp" alt="A diagram of how the avatar is generated." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-background-diagram.webp" alt="A diagram showing how the background is generated." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-outline-diagram.webp" alt="A diagram showing how the outline is generated." themed mobile />
</div>
...
<div className="main">
  <Picture src="/assets/case-studies/lysterfield-lake/image-dreams-diagram.webp" alt="A diagram showing the dreams." themed mobile />
</div>
...
<div className="wide">
  <Picture src="/assets/case-studies/lysterfield-lake/image-screencast-frame.webp" alt="The rendered final output." />
</div>
...
<div className="sidebar">
  <Picture src="/assets/case-studies/lysterfield-lake/image-cover-art.webp" alt="Brightly - Lysterfield Lake (cover art)" />
